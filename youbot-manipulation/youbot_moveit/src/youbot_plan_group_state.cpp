...
int main(int argc, char **argv)
{
    ...
    moveit::planning_interface::MoveGroup plan_group("arm_1"); //arm_1, arm_1_gripper
    ...
    // group state values
    current_state.setToDefaultValues(current_state.getJointModelGroup("arm_1"), "open"); //candle, folded, open, close

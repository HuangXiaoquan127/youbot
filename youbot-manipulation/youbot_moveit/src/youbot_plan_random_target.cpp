...
int main(int argc, char **argv)
{
    ...
    moveit::planning_interface::MoveGroup plan_group("arm_1");
    ...
    current_state.setToRandomPositions(current_state.getJointModelGroup("arm_1"));
    ...
    validity_request.group_name = "arm_1";

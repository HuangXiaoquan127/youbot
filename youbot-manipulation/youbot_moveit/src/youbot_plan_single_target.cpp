...
int main(int argc, char **argv)
{
    ...
    moveit::planning_interface::MoveGroup plan_group("arm_1");  //the name of group come from the moveit setup_assistant
	...
	//home pose
    goal.orientation.x = -0.00385699;
    goal.orientation.y = 0.176664;
    goal.orientation.z = -0.211258;
    goal.orientation.w = 0.961325;
    goal.position.x = 0.186526;
    goal.position.y = -0.00384618;
    goal.position.z = 0.371612;

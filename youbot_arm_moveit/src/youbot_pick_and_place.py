...
class CokeCanPickAndPlace:
    def __init__(self):
        ...
        self._approach_retreat_desired_dist = rospy.get_param('~approach_retreat_desired_dist', 0.3)
    ...
    def _add_table(self, name):
        ...
        self._scene.add_box(name, p, (0.8, 0.5, 0.02))
    ...
    def _add_coke_can(self, name):
        ...
        p.pose.position.y = 0.0
        p.pose.position.z = 0.02 + 0.01 + 0.3 - 0.02
